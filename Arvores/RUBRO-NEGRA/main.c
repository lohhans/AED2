	...
	for (int i = 0; i < argc; i++) {
		if(argv[i] != NULL){
			if(strcmp("-h", argv[i]) == 0){
				...
				\n-f <arquivo>		: indica o arquivo que contém os dados a serem adicionados na RUBRO-NEGRA \
				\n-m			: imprime o menor elemento da RUBRO-NEGRA \
				\n-M			: imprime o maior elemento da RUBRO-NEGRA \
				\n-a <elemento>		: imprime o antecessor na RUBRO-NEGRA do elemento ou caso contrário imprime -1 \
				\n-s <elemento>		: imprime o sucessor na RUBRO-NEGRA do elemento ou caso contrário imprime -1\n\n");
